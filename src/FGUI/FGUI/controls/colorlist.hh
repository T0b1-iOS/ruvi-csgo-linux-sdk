...
namespace fgui {
	...
	struct color_info {
		color_info(const std::string_view _identificator, const fgui::color &_color, bool _gradient = false) {
			...
			alpha_slider = std::make_unique<fgui::slider>();
			...
			plus_button = std::make_unique<fgui::button>();
			...
			minus_button = std::make_unique<fgui::button>();
			...
			gradient_checkbox = std::make_unique<fgui::checkbox>();
		...
		std::unique_ptr<fgui::slider> alpha_slider;
		std::unique_ptr<fgui::button> plus_button, minus_button;
		std::unique_ptr<fgui::checkbox> gradient_checkbox;
	...
	public:
		...
		void add_color(const std::string_view identificator, const fgui::color &color, bool gradient_state = false) noexcept {
		...
		void set_color(const int &index, const fgui::color &color, bool gradient_state = false) noexcept {
